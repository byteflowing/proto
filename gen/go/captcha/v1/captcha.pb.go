...
func (x *VerifyCaptchaReq) GetPhoneNumber() *v13.PhoneNumber {
	if x != nil {
...
type SendCaptchaResp_Data struct {
	...
	// 如果报错，这里有限制的原因
	Limit         *v14.LimitRule `protobuf:"bytes,2,opt,name=limit,proto3" json:"limit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*SendCaptchaResp_Data) Descriptor() ([]byte, []int) {
	return file_captcha_v1_captcha_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *SendCaptchaResp_Data) GetLimit() *v14.LimitRule {
	if x != nil {
		return x.Limit
	}
	return nil
...
var file_captcha_v1_captcha_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_captcha_v1_captcha_proto_goTypes = []any{
	...
	(*SendCaptchaResp_Data)(nil), // 4: captcha.v1.SendCaptchaResp.Data
	(v1.MessageSenderType)(0),    // 5: enums.v1.MessageSenderType
	(*v11.SendSmsReq)(nil),       // 6: sms.v1.SendSmsReq
	(*v12.SendMailReq)(nil),      // 7: mail.v1.SendMailReq
	(*v13.PhoneNumber)(nil),      // 8: types.v1.PhoneNumber
	(*v14.LimitRule)(nil),        // 9: limiter.v1.LimitRule
}
var file_captcha_v1_captcha_proto_depIdxs = []int32{
	5, // 0: captcha.v1.SendCaptchaReq.sender_type:type_name -> enums.v1.MessageSenderType
	6, // 1: captcha.v1.SendCaptchaReq.sms:type_name -> sms.v1.SendSmsReq
	7, // 2: captcha.v1.SendCaptchaReq.mail:type_name -> mail.v1.SendMailReq
	4, // 3: captcha.v1.SendCaptchaResp.data:type_name -> captcha.v1.SendCaptchaResp.Data
	5, // 4: captcha.v1.VerifyCaptchaReq.sender_type:type_name -> enums.v1.MessageSenderType
	8, // 5: captcha.v1.VerifyCaptchaReq.phone_number:type_name -> types.v1.PhoneNumber
	9, // 6: captcha.v1.SendCaptchaResp.Data.limit:type_name -> limiter.v1.LimitRule
