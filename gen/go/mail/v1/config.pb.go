...
const file_mail_v1_config_proto_rawDesc = "" +
	...
	"\x04smtp\x18\x06 \x01(\v2\r.mail.v1.SMTPB\x06\xbaH\x03\xc8\x01\x01R\x04smtp\"A\n" +
	"\n" +
	"MailConfig\x123\n" +
...
var file_mail_v1_config_proto_goTypes = []any{
	...
	(*MailConfig)(nil),          // 2: mail.v1.MailConfig
...
var file_mail_v1_config_proto_depIdxs = []int32{
	...
	1, // 4: mail.v1.MailConfig.providers:type_name -> mail.v1.MailProvider
