...
func (x *CommonResp) GetErrCode() uint32 {
	if x != nil {
		return x.ErrCode
	}
	return 0
...
func (x *CommonResp) GetErrMessage() string {
	if x != nil {
		return x.ErrMessage
	}
	return ""
...
func (x *CommonResp) GetErrDetail() string {
	if x != nil {
		return x.ErrDetail
	}
	return ""
...
const file_common_v1_common_proto_rawDesc = "" +
	...
	"\n" +
	"CommonResp\x12\x19\n" +
	"\berr_code\x18\x01 \x01(\rR\aerrCode\x12\x1f\n" +
	"\verr_message\x18\x02 \x01(\tR\n" +
	"errMessage\x12\x1d\n" +
	"\n" +
	"err_detail\x18\x03 \x01(\tR\terrDetailB\x99\x01\n" +
	"\rcom.common.v1B\vCommonProtoP\x01Z6github.com/byteflowing/proto/gen/go/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
